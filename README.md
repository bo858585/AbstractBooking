...
Схема отображения кнопок в столбце таблицы:
...
(4*) (Продвинутый вариант таблицы) ###Рендеринг таблицы:
